    ...
    <!-- Dropzone -->
    <script src="../assets/admin/js/plugin/dropzone/dropzone.min.js"></script>

    <!-- Fullcalendar -->
    <script src="../assets/admin/js/plugin/fullcalendar/fullcalendar.min.js"></script>
    ...
    <!-- Summernote -->
    <script src="../assets/admin/js/plugin/summernote/summernote-lite.min.js"></script>
    ...
    <!-- Owl Carousel -->
    <script src="../assets/admin/js/plugin/owl-carousel/owl.carousel.min.js"></script>

    <!-- Magnific Popup -->
    <script src="../assets/admin/js/plugin/jquery.magnific-popup/jquery.magnific-popup.min.js"></script>
